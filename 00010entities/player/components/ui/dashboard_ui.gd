...
var stats_panel_script = preload("res://00010entities/player/components/ui/stats_panel.gd")
var skills_panel_script = preload("res://00010entities/player/components/ui/skills_panel.gd")
