...
func _ready():
	...
	var DashboardScript = load("res://00010entities/player/components/ui/dashboard_ui.gd")
	if DashboardScript:
	...
	var ScannerHUDScript = load("res://00010entities/player/components/ui/scanner_hud.gd")
	if ScannerHUDScript:
	...
	var TradeUIScript = load("res://00010entities/player/components/ui/trade_ui.gd")
	if TradeUIScript:
