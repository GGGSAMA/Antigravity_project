...
func _run():
	...
	DirAccess.make_dir_recursive_absolute("res://00030entities/player/models/")
	var err = ResourceSaver.save(packed_scene, "res://00030entities/player/models/fem_warrior.tscn")
	if err == OK:
