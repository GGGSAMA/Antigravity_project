...
const WanderProcessors = preload("res://0000core/000010_simulation/transactions/processors/wander_processors.gd")
const HuntProcessors = preload("res://0000core/000010_simulation/transactions/processors/hunt_processors.gd")
const CombatProcessors = preload("res://0000core/000010_simulation/transactions/processors/combat_processors.gd")
const CultivateProcessors = preload("res://0000core/000010_simulation/transactions/processors/cultivate_processors.gd")
