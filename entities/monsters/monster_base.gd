...
func _ready() -> void:
	...
	if get_node_or_null("Model") == null:
		var model_path = monster_data.get("model_path", "res://models/characters/gdquest_sophia/sophia_skin.tscn")
...
func _init_from_database() -> void:
	var MonsterDatabase = load("res://components/monster_database.gd")
	if MonsterDatabase:
